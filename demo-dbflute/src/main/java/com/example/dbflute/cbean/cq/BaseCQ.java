...
import com.example.dbflute.cbean.cq.bs.BsBaseCQ;

/**
 * The condition-query of BASE.
 * <p>
 ...
 */
public class BaseCQ extends BsBaseCQ {
     ...
     */
    public BaseCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
