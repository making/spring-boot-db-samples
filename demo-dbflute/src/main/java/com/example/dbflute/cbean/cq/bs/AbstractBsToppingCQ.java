...
/**
 * The abstract condition-query of TOPPING.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsToppingCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsToppingCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * {exists (select TOPPINGS_ID from PIZZA_TOPPINGS where ...)} <br>
     * PIZZA_TOPPINGS by TOPPINGS_ID, named 'pizzaToppingsAsOne'.
     * <pre>
    ...
    public void existsPizzaToppings(SubQuery<PizzaToppingsCB> subCBLambda) {
        ...
        registerExistsReferrer(cb.query(), "ID", "TOPPINGS_ID", pp, "pizzaToppingsList");
    }
    public abstract String keepId_ExistsReferrer_PizzaToppingsList(PizzaToppingsCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select TOPPINGS_ID from PIZZA_TOPPINGS where ...)} <br>
     * PIZZA_TOPPINGS by TOPPINGS_ID, named 'pizzaToppingsAsOne'.
     * <pre>
    ...
    public void notExistsPizzaToppings(SubQuery<PizzaToppingsCB> subCBLambda) {
        ...
        registerNotExistsReferrer(cb.query(), "ID", "TOPPINGS_ID", pp, "pizzaToppingsList");
    }
    ...
    public void xsderivePizzaToppingsList(String fn, SubQuery<PizzaToppingsCB> sq, String al, DerivedReferrerOption op) {
        ...
        registerSpecifyDerivedReferrer(fn, cb.query(), "ID", "TOPPINGS_ID", pp, "pizzaToppingsList", al, op);
    }
    ...
    public void xqderivePizzaToppingsList(String fn, SubQuery<PizzaToppingsCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        registerQueryDerivedReferrer(fn, cb.query(), "ID", "TOPPINGS_ID", sqpp, "pizzaToppingsList", rd, vl, prpp, op);
    }
     ...
     */
    public HpSLCFunction<ToppingCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ToppingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ToppingCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ToppingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ToppingCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ToppingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ToppingCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ToppingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ToppingCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ToppingCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ToppingCB&gt;() {
     *     public void query(ToppingCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ToppingCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ToppingCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ToppingCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ToppingCQ sq);

    protected ToppingCB xcreateScalarConditionCB() {
        ToppingCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ToppingCB xcreateScalarConditionPartitionByCB() {
        ToppingCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ToppingCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ToppingCB cb = new ToppingCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ToppingCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ToppingCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ToppingCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ToppingCB cb = new ToppingCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ToppingCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ToppingCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ToppingCB cb = new ToppingCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ToppingCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ToppingCB newMyCB() {
        return new ToppingCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ToppingCQ.class.getName(); }
