...
import com.example.dbflute.cbean.cq.bs.BsPizzaToppingsCQ;

/**
 * The condition-query of PIZZA_TOPPINGS.
 * <p>
 ...
 */
public class PizzaToppingsCQ extends BsPizzaToppingsCQ {
     ...
     */
    public PizzaToppingsCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
